...
package com.github.yjjqrqqq.mybatis_generator.plugins.utils.enhanced;
...
public class TemplateCommentGenerator implements CommentGenerator {
        ...
        try {
            ...
            if (useForDefault) {
                ...
                if (file.exists()) {
                    ...
                    System.out.println("没有找到对应注释模板:" + templatePath);
                }
            }
            ...
            System.out.println("注释模板XML解析失败！" + e);
        }
    }
    ...
    private String[] getComments(Map<String, Object> map, EnumNode node) {
        ...
        try {
            ...
            System.out.println("freemarker 解析失败！" + e);
        }
    ...
    /**
     * Adds the enums comment.
     *
     * @param innerEnum         the inner enums
     * @param introspectedTable the introspected table
     */
    @Override
