...
/**
 * @author liuyixin
 * @date 2018/11/2914:41
 */
public class Generator {

    public static void main(String[] args) throws Exception {
        BaseClassPlugin.projectName = "dao";
        List<String> warnings = new ArrayList<String>();
        boolean overwrite = false;
        File configFile = new File(Thread.currentThread().getContextClassLoader().getResource("mybatis-generator-config.xml").getPath());
